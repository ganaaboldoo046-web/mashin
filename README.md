...
Pull requests run build and lint checks. A verified push to `main` deploys the exact commit to the `mashin` Cloudflare Pages project through `.github/workflows/deploy.yml`.
