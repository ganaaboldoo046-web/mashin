...
import { onRequestGet as __api_admin_stats_ts_onRequestGet } from "C:\\Users\\agape\\OneDrive\\바탕 화면\\TEMMUN CAR\\functions\\api\\admin_stats.ts"
...
import { onRequestDelete as __api_reservations_delete_ts_onRequestDelete } from "C:\\Users\\agape\\OneDrive\\바탕 화면\\TEMMUN CAR\\functions\\api\\reservations_delete.ts"
...
import { onRequestPost as __api_reviews_create_ts_onRequestPost } from "C:\\Users\\agape\\OneDrive\\바탕 화면\\TEMMUN CAR\\functions\\api\\reviews_create.ts"
import { onRequestGet as __api_reviews_list_ts_onRequestGet } from "C:\\Users\\agape\\OneDrive\\바탕 화면\\TEMMUN CAR\\functions\\api\\reviews_list.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "DELETE",
      middlewares: [],
      modules: [__api_reservations_delete_ts_onRequestDelete],
    },
  {
    ...
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_reviews_create_ts_onRequestPost],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_reviews_list_ts_onRequestGet],
    },
  {
