...
// ../.wrangler/tmp/bundle-yqpBlG/checked-fetch.js
...
async function onRequest2(context) {
  ...
  if (request.method === "GET") {
    try {
      const { results: results2 } = await db.prepare("SELECT * FROM banners").all();
...
async function onRequest4(context) {
  ...
  try {
    ...
    const { results: results2 } = await db.prepare("SELECT * FROM categories ORDER BY sort_order ASC, id ASC").all();
    return new Response(JSON.stringify(results2 || []), {
      headers: { "Content-Type": "application/json" }
    });
  } catch (err) {
...
async function onRequest8(context) {
  ...
  try {
    const { results: results2 } = await db.prepare("SELECT * FROM products ORDER BY created_at DESC").all();
    return new Response(JSON.stringify(results2 || []), {
      headers: { "Content-Type": "application/json" }
    });
  } catch (err) {
...
// ../.wrangler/tmp/pages-8pI83a/functionsRoutes-0.10892350764201275.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-yqpBlG/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-yqpBlG/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.03871215714412035.mjs.map
