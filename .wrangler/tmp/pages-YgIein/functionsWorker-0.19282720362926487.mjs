...
// ../.wrangler/tmp/bundle-tjJh0b/checked-fetch.js
...
var onRequestPost = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    const { success } = await env.DB.prepare(
      "INSERT INTO reservations (product_id, product_name, user_name, phone, facebook_id) VALUES (?, ?, ?, ?, ?)"
    ).bind(body.productId, body.productName, body.userName, body.phone, body.facebookId || "").run();
    if (success) {
...
// ../.wrangler/tmp/pages-YgIein/functionsRoutes-0.7243987273913556.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-tjJh0b/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-tjJh0b/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.19282720362926487.mjs.map
